...
C     surfaceForcingPTr :: passive tracer surface forcing
     ...
     &              PTRACERS_num)
      _RL phy_chl2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL l_lim_sp_field2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL l_lim_lp_field2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL tmp_field2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL chl2c_sp_field2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL chl2c_lp_field2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL pTracer_tavg_field2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy,
     &              PTRACERS_num)
		
      COMMON /PTRACERS_FIELDS/
     &              pTracer, gpTrNm1, surfaceForcingPTr,
     &              phy_chl2, l_lim_sp_field2, l_lim_lp_field2,
     &              tmp_field2, chl2c_sp_field2, chl2c_lp_field2,
     &		    pTracer_tavg_field2
