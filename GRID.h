...
C     globalArea :: Domain Integrated horizontal Area [m2]
     ...
     &  gravitySign, rkSign, globalArea, globalVolume, depth_uv, depth_w
...
C     fCoriCos  :: Coriolis Cos(phi) parameter at grid Center point (for NH)
     ...
     &  fCori, fCoriG, fCoriCos, cellVolume 
      ...
      _RS depth          (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      ...
      _RS cellVolume     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
